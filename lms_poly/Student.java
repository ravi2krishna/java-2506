...
public class Student extends AbstractPerson implements Personable, Payables {
   ...
   public void calaculatePayment() {
    double discount = 0;
       ...
       System.out.println("1) NetBanking 2) Credit Card 3) UPI");
       ...
       if (option == 1) {
        ...
        processor.makePayment(finalFee,nb.getBankName());
       } else if (option == 2) {
        CreditCardPayment cc = new CreditCardPayment();
        cc.setcardNumber(cc.getcardNumber());
        System.out.println("PAYING FEE: "+finalFee);
        PaymentProcessor processor = new PaymentProcessor();
        processor.makePayment(finalFee,cc.getcardNumber());
       } else if (option == 3) {
        ...
        System.out.println("PAYING FEE: "+finalFee);
        PaymentProcessor processor = new PaymentProcessor();
        processor.makePayment(finalFee,upi.getUpiId(),upi.getUpiPaymentType());
       } else {
        System.out.println("You can select only Option 1 or 2 or 3");
       }
